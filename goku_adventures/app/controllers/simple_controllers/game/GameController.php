...
/**
 * Nom de la class: GameController()
 *
...
namespace App\Controllers\Simple_controllers\Game;

class GameController extends \Core\System\ControllersProviderSystem
{
    /**
    ...
    {
        $this->setPageView('game.twig');
        $this->setPageInfos(array(
            'page_title' => 'Goku Adventures'
        ));
    }
